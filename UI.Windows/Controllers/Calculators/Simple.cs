...
internal sealed class Simple
{
    public Simple(Label result, TextBox inputLeft, TextBox inputRight, ListBox history,
                      Button sum, Button multiply, Button divide, Button deduct, Button clear, Button clearHistory)
    {
        UIData.UpdateLabel(result, string.Empty);
        UIData.UpdateTextBox(inputLeft, string.Empty);
        UIData.UpdateTextBox(inputRight, string.Empty);
        ...
        sum.Click += (s, e) =>
        {
            ...
            {
                UIData.UpdateLabel(result, calculation);
        ...
        result.Click += (s, e) => UIData.CopyToClipboard(result.Text);
    }
}